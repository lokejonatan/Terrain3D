...
private:
	...
	// Override maps for external tool integration (persistent NDE storage)
	Ref<Image> _height_map_override;
	Ref<Image> _control_map_override;
	Ref<Image> _color_map_override;
	// Instancer
...
public:
	...
	void set_height_map_override(const Ref<Image> &p_map);
	Ref<Image> get_height_map_override() const { return _height_map_override; }
	void set_control_map_override(const Ref<Image> &p_map);
	Ref<Image> get_control_map_override() const { return _control_map_override; }
	void set_color_map_override(const Ref<Image> &p_map);
	Ref<Image> get_color_map_override() const { return _color_map_override; }
	void sanitize_maps();
